...
function get_page_info($current_page) {
	$pages = array(
		...
		array(
			...
			"sub_of" => "blog.php",
			"prev_link" => "blog-041419.php",
			"prev_link_label" => "previous post"
		),
		array(
			"page" => "blog-041419.php",
			"add_to_menu" => false,
			"menu_label" => null, 
			"page_title" => "Liz Burton Blog",
			"sub_of" => "blog.php",
			"prev_link" => "blog-040719.php",
			"prev_link_label" => "previous post",
			"next_link" => "blog.php",
			"next_link_label" => "next post"
		),
		array(
			"page" => "blog-040719.php",
			"add_to_menu" => false,
			"menu_label" => null, 
			"page_title" => "Liz Burton Blog",
			"sub_of" => "blog.php",
			"prev_link" => "blog-033119.php",
			"prev_link_label" => "previous post",
			"next_link" => "blog-041419.php",
			"next_link_label" => "next post"
		),
		array(
			"page" => "blog-033119.php",
			"add_to_menu" => false,
			"menu_label" => null, 
			"page_title" => "Liz Burton Blog",
			"sub_of" => "blog.php",
			"prev_link" => "blog-032419.php",
			"prev_link_label" => "previous post",
			"next_link" => "blog-040719.php",
			"next_link_label" => "next post"
		),
		array(
			"page" => "blog-032419.php",
			"add_to_menu" => false,
			"menu_label" => null, 
			"page_title" => "Liz Burton Blog",
			"sub_of" => "blog.php",
			"prev_link" => "blog-031719.php",
			"prev_link_label" => "previous post",
			"next_link" => "blog-033119.php",
			"next_link_label" => "next post"
		),
		array(
			"page" => "blog-031719.php",
			"add_to_menu" => false,
			"menu_label" => null, 
			"page_title" => "Liz Burton Blog",
			"sub_of" => "blog.php",
