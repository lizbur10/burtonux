    ...
    <section id="content">
        ...
        <article class="blog-post">
            ...
            <p>
                ...
                I'm working on and forget, sometimes for hours. It happens all too frequently: I lift my 
                head from an absorbing challenge or difficult debugging situation and realize 
                that I've changed dozens of lines of code since my last commit. Ideally, according to best practice guidelines, 
                commits should be done every 3 to 7 minutes and should include no more than about 15 lines of code. 
                Furthermore, they should  
                include meaningful commit messages, which is difficult to do when you're trying
                to describe dozens of lines of changes. Unfortunately, there are many commits in my Git history that fall 
                pretty far short
                of best practice. Recently, however, I've discovered two 
                tools, readily available in my work environment, that have proven to help a lot when that 
            ...
            <p>
                ...
                for which I got the thing. As a result, I rarely get farther than scraping the 
                surface of what's available to me. While I was aware that VS Code included  
            ...
            <p>
                ...
                One day, I had broken something in my code and wasn't sure what got me there. I couldn't remember what I'd 
                changed or in which files. But, happily, I clicked on the Source Control button in VS Code  
                and, Eureka!, there was a list of the files that had been changed since my last commit. Even more
                happily, when I clicked on one of the files, it showed me a side by side comparison of the last-committed 
                and current versions. This helped me figure out what I had broken and to fix it, but I also recognized another, 
                very important use for this newly-discovered functionality: now, if I had a lot of changes to commit, I 
            ...
            <p>
                The second thing I discovered that helps me when I'm in this situation is Git's 
                <a target="_blank" class="text-link" href="https://git-scm.com/book/en/v2/Git-Tools-Interactive-Staging">
                interactive staging interface</a>. When using the usual command-line interface, typing 
            ...
            <p>
                ...
                files individually isn't difficult, it can be monotonous to type or copy/paste files one by one. 
                Furthermore, if you stage a file mistakenly, the command to unstage from the command line is not 
            ...
            <p>
                Once you've finished selecting all your files, hit enter on the blank command line to go back to the 
            ...
            <p>
                ...
                Once you've finished, you quit the interactive interface (<span class="inline-snippet">7</span> or 
                <span class="inline-snippet">q</span>) and
                commit your files, then enter the interface again if you need to stage more files. 
            </p>
            <p>
                While the process I've described above is no substitute for following good commit practices as you go, it
